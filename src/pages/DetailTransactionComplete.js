...
export default class DetailTransactionComplete extends Component {
    ...
    componentWillMount() {
        ...
        axios.get(`http://localhost:3001/detail-transaction-complete?id_user=${this.props.match.params.idUser}&id_transaction=${this.props.match.params.idTransaction}`)
            .then((response) => {
                this.setState({
