...
export default class DetailTransactionOnDelivery extends Component {
    ...
    componentWillMount() {
        ...
        axios.get(`http://localhost:3001/detail-transaction-on-delivery?id_user=${this.props.match.params.idUser}&id_transaction=${this.props.match.params.idTransaction}`)
            .then((response) => {
                this.setState({
