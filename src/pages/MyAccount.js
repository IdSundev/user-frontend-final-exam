...
export default class Test extends Component {
  ...
  componentWillMount() {
    ...
    axios
      .post(`http://localhost:3001/select`, formData, {})
      .then((response) => {
        this.setState({
  ...
  insert(refs) {
    ...
    axios
      .post("http://localhost:3001/editinformation", formData, {
        // headers: {
        //     ...formHeaders,
        // },
      })
              ...
              <div className="login-title">
                ...
                <div className="comments-area payment-confirmation">
                  <div className="user_img">
                    <img
                      src={`http://localhost:3001/images/${this.state.user.profile}`}
                      alt=""
                    />
                    <input
                      type="file"
                  ...
                  <form>
                    ...
                    <p>
                      ...
                      <input
                        type="text"
                        ref="birth_of_date"
                        defaultValue={this.state.user.birth_of_date}
                      />
                    </p>
                    <p>
                      <label>Gender</label>
